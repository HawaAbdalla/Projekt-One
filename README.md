...
-------
This project is a Python-based data pipeline and dashboard designed to analyze speeches given by Donald Trump. The purpose is to scrape, process, and visualize speech data using a variety of tools and techniques, including Selenium, pandas, and Dash.
All core functionality is divided into separate Python scripts, which can be found in the `scripts/` folder. Each script handles a different stage of the data workflow — from web scraping to natural language processing and final visualization.
-------
